...
class TestService(
    ...
    fun initUsers() {
        ...
        val encryptPassword1 = encoder.encode("admin123")
        val encryptPassword2 = encoder.encode("123456")
        ...
        val admin = User("admin", encryptPassword1, Gender.M, adminRoleSet, adminCart)
        val user = User("abc", encryptPassword2, Gender.F, userRoleSet, userCart)
